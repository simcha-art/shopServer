...
const writeBooksFile = (data) => fs.writeFile(DB_BOOKS, JSON.stringify(data));
const writeOrdersFile = (data) => fs.writeFile(DB_ORDERS, JSON.stringify(data));
const writeCustomersFile = (data) => fs.writeFile(DB_CUSTOMERS, JSON.stringify(data));
